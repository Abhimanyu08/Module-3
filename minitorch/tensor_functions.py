    ...
    class Backend:
        ...
        class Sigmoid(Function):
            ...
            def backward(ctx, grad_output):
                # TODO: Implement for Task 2.3.
                a = ctx.saved_values
                return grad_output*(sigmoid_map(a) - mul_zip(sigmoid_map(a), sigmoid_map(a)))
        ...
        class Permute(Function):
            ...
            def forward(ctx, a, order):
                # TODO: Implement for Task 2.2.
                ctx.save_for_backward(list(order))
            ...
            def backward(ctx, grad_output):
                ...
                n_order = [order.index(i) for i in range(len(order))]
                return grad_output._new(grad_output._tensor.permute(*n_order))
